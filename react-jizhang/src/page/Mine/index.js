...
export default class Mine extends React.Component{
    ...
    render(){
        if(window.localStorage.token){
            ...
            return(<div>
                <Route exact path="/app/Mine"><Userlogin></Userlogin></Route>
                <Route path="/app/Mine/Userregister"><Userregister></Userregister></Route>
                <Route path="/app/Mine/Forgetpsw"><Forgetpsw></Forgetpsw></Route>
            </div>)
        }

...
import Userlogin from '../../page/Mine/Userlogin'
import Userregister from '../../page/Mine/Userregister'
import Forgetpsw from '../../page/Mine/Forgetpsw'
        ...
        return (<div className={rcss.container}>
           <HashRouter>
                    <Switch>
                        ...
                        <Route exact path="/app/login"><Userlogin></Userlogin></Route>
                        <Route path="/app/Userregister"><Userregister></Userregister></Route>
                        <Route path="/app/Forgetpsw"><Forgetpsw></Forgetpsw></Route>
                    </Switch>
                </HashRouter>
        </div>)
    }

...
class Accountdetail extends Component {
    ...
    render() {
        var typename=null
        switch(this.state.accountdata.type){
            case 1:
                typename="现金"
                break
            case 2:
            ...
            <div style={{backgroundColor:"white",paddingTop:"40px"}}>
                ...
                <Spin spinning={this.state.spinstatu}>
                    <Descriptions layout="vertical" column={2} bordered>
                        ...
                        <Descriptions.Item label="账户类型">{typename}</Descriptions.Item>
                        ...
                        <Descriptions.Item label="创建时间" span={2}>{this.state.accountdata.created_at}</Descriptions.Item>
                        <Descriptions.Item label="更新时间" span={2}>{this.state.accountdata.updated_at}</Descriptions.Item>
                        <Descriptions.Item label="备注" span={2}>{this.state.accountdata.remark===""?"未添加备注。":this.state.accountdata.remark}</Descriptions.Item>
                        <Descriptions.Item label="月收支金额" span={2}>
                        ...
                        <Descriptions.Item label="年月" span={2}>{this.state.month.month}</Descriptions.Item>

...
import { InputNumber ,Select, DatePicker, Alert ,Spin, Button,Input, Radio, message} from 'antd';
                ...
                Axios({
                    ...
                    if (response.data.status ===true) {
                        ...
                        this.setState({
                            ...
                            createHashHistory().push("/app/Recordlist")
                        })
                    } else {
        ...
        return (
            <div className={rcss.createcontainer} style={{paddingTop:"40px"}}>
                ...
                <div className={rcss.errorhidden} id="accounterrorbox">
                    <Alert message="Error 记账账户不能为空" type="error" showIcon/>
                </div>
                ...
                <table className={rcss.thetable}>
                    <tbody>
                        <tr>
                            <td><span style={{color:"red"}}>*</span>记账金额：</td>
                            <td><InputNumber style={{width:"100%"}} defaultValue={0} onChange={(value)=>{
                                    this.setState({
                                        total_money:value
                                    })
                                }}/></td>
                        ...
                        <tr>
                            <td><span style={{color:"red"}}>*</span>实付金额：</td>
                            <td><InputNumber style={{width:"100%"}} defaultValue={0} onChange={(value)=>{
                                    this.setState({
                                        money:value
                                    })
                        ...
                        <tr>
                            <td><span style={{color:"red"}}>*</span>记账账户：</td>
                            <td>
                        ...
                        <tr>
                            <td><span style={{color:"red"}}>*</span>收支类别：</td>
                            <td>
                        ...
                        <tr>
                            <td>交易对象：</td>
                            <td><Input style={{width:"100%"}} onChange={(e)=>{
                                this.setState({
